        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Actors_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _2FA = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupShow", x => new { x.GroupsId, x.ShowsId });
                    table.ForeignKey(
                        name: "FK_GroupShow_Groups_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorGroup", x => new { x.ActorsId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_ActorGroup_Actors_ActorsId",
                        column: x => x.ActorsId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorGroup_Groups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isTransfered = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransferedTickets", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorGroup_GroupsId",
                table: "ActorGroup",
                column: "GroupsId");

            migrationBuilder.CreateIndex(
                name: "IX_Actors_IdentityUserId",
                table: "Actors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferedTickets_PerformanceId",
                table: "TransferedTickets",
                column: "PerformanceId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferedTickets_SeatId",
                table: "TransferedTickets",
                column: "SeatId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferedTickets_VisitorId",
                table: "TransferedTickets",
                column: "VisitorId");
